...
import { MapPin, Calendar, Landmark, Users, Building, Globe, Mountain, Link as LinkIcon } from 'lucide-react';
import Link from 'next/link';
import { getTempleBySlug, type Temple } from '@/data/temples';
import { notFound } from 'next/navigation';

export default async function VenkateswaraTirumalaTemplePage() {
  const temple = await getTempleBySlug('venkateswara-tirumala');
    ...
    <div className="container mx-auto px-4 py-12">
      <Card className="overflow-hidden shadow-lg mb-12">
        <div className="relative h-64 md:h-96">
          <Image
            src={temple.imageUrl || `https://picsum.photos/seed/tirumala-venkateswara/1200/400`}
            alt={temple.name}
            layout="fill"
            objectFit="cover"
               ...
               {temple.architecture && (
                 <div>
                   ...
                   <ul className="list-disc list-inside text-muted-foreground text-sm space-y-1 pl-2">
                     ...
                     {temple.architecture.creator && <li><strong>Notable Contributors:</strong> {temple.architecture.creator}</li>}
