...
export default async function KallalagarTemplePage() {
  const temple = await getTempleBySlug('kallalagar');
    ...
    <div className="container mx-auto px-4 py-12">
      <Card className="overflow-hidden shadow-lg mb-12">
        <div className="relative h-64 md:h-96">
          <Image
            src={temple.imageUrl || `https://picsum.photos/seed/kallalagar-temple/1200/400`}
            alt={temple.name}
            layout="fill"
            objectFit="cover"
